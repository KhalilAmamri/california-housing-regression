...
st.set_page_config(
    ...
    menu_items={
        'Get Help': 'https://github.com/KhalilAmamri/california-housing-regression',
        'Report a bug': 'https://github.com/KhalilAmamri/california-housing-regression/issues',
        'About': '''
        ...
        **Built with Multiple Linear Regression**
        ...
        [View on GitHub](https://github.com/KhalilAmamri/california-housing-regression)
        '''
    }
)
